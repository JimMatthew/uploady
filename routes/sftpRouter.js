...
module.exports = function(isAuthenticated) {
    ...
    router.post('/save-server', isAuthenticated, sftpController.sftp_save_server_post)

    router.post('/delete-server', isAuthenticated, sftpController.sftp_delete_server_post)

    router.post('/delete-file', isAuthenticated, sftpController.sftp_delete_file_post)

    router.post('/delete-folder', isAuthenticated, sftpController.sftp_delete_folder_post)

    router.get('/console/:serverId', isAuthenticated, sftpController.ssh_console_get )
